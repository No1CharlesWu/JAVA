...
public class SettingAlertFragment extends BaseBackFragment {
    ...
    public static SettingAlertFragment newInstance() {
        return new SettingAlertFragment();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.setting_alert_fragment, container, false);
        initView(view);
    ...
    public void save(View v){
        ...
        service.saveAlert(Integer.valueOf(minfo_s),Integer.valueOf(minfo_r),Integer.valueOf(mwarning_s),Integer.valueOf(mwarning_r),Integer.valueOf(merror_s),Integer.valueOf(merror_r),Integer.valueOf(mcritical_s),Integer.valueOf(mcritical_r));
